...
{ 
   ...
   private string _gender;
    ...
    public HealthProfile(string FirstName, string LastName, int DayOfBirth, string MonthOfBirth, int YearOfBirth, int WeightInPounds, int HeightInInches, string Gender)
    {
